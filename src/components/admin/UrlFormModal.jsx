        ...
        <div className="flex items-start justify-between">
          <div>
            <h3 className="text-base font-semibold text-white">
              {mode === "create" ? "Add URL" : "Edit URL"}
            </h3>
            <p className="mt-1 text-sm text-slate-500">
              {mode === "create"
                ? "The URL's domain must already exist in Domain Management."
                : "Update this URL's listing details."}
            </p>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div>
            ...
            <p className="mt-1.5 text-xs text-slate-500">
              The domain must already exist in Domain Management. Add it
              there first if needed.
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {["BLACKLIST", "WHITELIST"].map((option) => (
                <button
                  ...
                  className={`rounded-lg cursor-pointer border px-3 py-2 text-sm font-medium transition ${
          ...
          {isBlacklist && (
            <div>
              ...
              <select
                ...
                className="w-full cursor-pointer rounded-lg border border-white/10 bg-[#0a0e1a] px-3 py-2 text-sm text-white outline-none focus:border-cyan-400/50 focus:ring-1 focus:ring-cyan-400/50"
              >
          ...
          <div>
            ...
            <textarea
              rows={3}
              placeholder="Why is this URL listed?"
              value={form.reason}
